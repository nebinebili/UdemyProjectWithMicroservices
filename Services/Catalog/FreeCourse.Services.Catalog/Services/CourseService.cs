...
namespace FreeCourse.Services.Catalog.Services
{
    public class CourseService:ICourseService
    {
        ...
        {
            var courses = await _courseCollection.Find(corse => true).ToListAsync();
        ...
        public async Task<Response<NoContent>> UpdateAsync(CourseUpdatedDto courseUpdatedDto)
        {
            var updateCourse=_mapper.Map<Course>(courseUpdatedDto);
